...
class FluidSynth:
    """ Represent the FluidSynth synth object as defined in synth.h.
    ...
    def __init__(self, handle, settings):
        """ Create a new FluidSynth synth instance using the given handle and settings. """
        self.handle = handle
    ...
    def __del__(self):
        """ Remove all soundfonts and delete synth instance. """
        failed = []
    ...
    def cc(self, channel, control, value):
        ...
        An alias method "control_change" exists.
    ...
    def pitch_wheel_sens(self, channel, value):
        ...
        An alias method "pitch_wheel_sensitivity" exists.
